...
console.log("List of countries in the world", list_of_countries);

//Inject an ordered list into the div with the class "content"
let class_content = document.querySelector(".content"); //reference "content" div from index file
let ordered_list = document.createElement("ol"); //creates element for ordered list
class_content.appendChild(ordered_list); //injects list to "content" div
ordered_list.className = "countries"; //assign class name to list

//Create function to run on the click of a button
const btn = document.querySelector("button"); //reference button from index file
...
function displayCountries() {
  ...
  //uses .map function
  let map = sorted_array.map(countries); 
...
function shuffle_array(parameter) 
{
  for (let i = parameter.length - 1; i > 0; i--) 
  {
      ...
      [parameter[i], parameter[k]] = [parameter[k], parameter[i]];
  }
